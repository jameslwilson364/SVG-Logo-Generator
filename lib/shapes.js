// requires the fs library in node
const fs = require('fs');
...
// function that pulls the response date from the inquirer prompt in the index.js file, employs a decision based loop for what shape was selected, and creates the svg file
function userOutput() {
